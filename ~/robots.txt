User-agent: all
Allow: keep always lucky and beneficial triple all of times without any cheating continuously triple split multiplied continuously split triple all the times 
...
Disallow: prod.outgoing.prod.webservices.mozgcp.net
Disallow: .mozgcp.net
Disallow: ad services api
Disallow: adsense or ads or ad
Disallow: .pool.com
Disallow: pool.com
Disallow: myadcentre.google.com
Disallow: /ads
Disallow: .ads.
Disallow: -ads.
Disallow:.ad.
...
Disallow: /ad.
Disallow: advert
Disallow: .gstatic.com
Disallow: .admob.com
Disallow: .analytics.localytics.com
Disallow: .greystripe.com
Disallow: inmobi.com
Disallow: admax.nexage.com
Disallow: my.mobfox.com
Disallow: .plus1.wapstart.ru
Disallow: .madnet.ru
Disallow: about:blank
Disallow: .inmobi.com
Disallow: .mp.mydas.mobi
Disallow: millennialmedia.com
Disallow: .g.doubleclick.net
Disallow: .appsdt.com
Disallow: run.admost.com
Disallow: mobile.admost.com
Disallow: amazon-adsystem.com
Disallow: .appnext.com
Disallow: .flurry.com
Disallow: googlesyndication.com
Disallow: google.com/dfp
Disallow: inmobicdn.net
Disallow: moatads
Disallow: .mopub.com
Disallow: unityads.unity3d.com
Disallow: adc3-launch
Disallow: adcolony.com
Disallow: mobile-static.adsafeprotected
Disallow: applovin.com
Disallow: applvn.com
Disallow: appnext.hs
Dissalow: live.chartboost.com
Disallow: www.dummy.com
Disallow: .api.vungle.com
Disallow: pubnative.net
Disallow: supersonicads.com
Disallow: info.static.startappservice.com
Disallow: init.startappservice.com
Disallow: req.startappservice.com
Disallow: imp.startappservice.com
Disallow: sb.scorecardresearch.com
Disallow: crashlytics.com
Disallow: udm.scorecardresearch.com
adz.wattpad.com
Dosallow: ad.api.kaffnet.com
Disallow: dsp.batmobil.net
Disallow: 61.145.124.238
Disallow: alta.eqmob.com
Disallow: graph.facebook.
Disallow: t.appsflyer.com
net.rayjump.com
Disallow: .yandex.net
Disallow: appodeal.com
...
yandexadexchange.
Disallow: yandex.com
Disallow: tapjoyads.com
tapjoy.com
Dissalow: .example.com
Disallow: com.google.android.gms.ads.identifier.service.START
Disallow: ads.mopub.com
Disallow: doubleclick.net
Disallow: googleadservices.com
...
Allow: multiple from Multiplication split multiple double multiply continously make it double to do something
...
## new ## 
Disallow: WordupInfoSearch
Disallow: WebDataStats
Disallow: HttpUrlConnection
Disallow: Seekport Crawler
Disallow: ZoomBot
Disallow: VelenPublicWebCrawler
Disallow: MoodleBot
Disallow: jpg-newsbot
Disallow: outbrain
Disallow: W3C_Validator
Disallow: Validator.nu
Disallow: W3C-checklink
Disallow: W3C-mobileOK
Disallow: W3C_I18n-Checker
Disallow: FeedValidator
Disallow: W3C_CSS_Validator
Disallow: W3C_Unicorn
Disallow: Google-PhysicalWeb
Disallow: Blackboard
Disallow: ICBot
Disallow: BazQux
Disallow: Twingly
Disallow: Rivva
Disallow: Experibot
Disallow: awesomecrawler
Disallow: Dataprovider.com
Disallow: GroupHigh
Disallow: theoldreader.com
Disallow: AnyEvent
Disallow: Uptimebot.org
Disallow: Nmap Scripting Engine
Disallow: 2ip.ru
Disallow: Clickagy
Disallow: Caliperbot
Disallow: MBCrawler
Disallow: online-webceo-bot
Disallow: B2B Bot
Disallow: AddSearchBot
Disallow: Google Favicon
Disallow: HubSpot
Disallow: Chrome-Lighthouse
Disallow: HeadlessChrome
Disallow: CheckMarkNetwork
Disallow: www.uptime.com
Disallow: Streamline3Bot
Disallow: serpstatbot
Disallow: MixnodeCache
Disallow: ^curl
Disallow: SimpleScraper
Disallow: RSSingBot
Disallow: Jooblebot
Disallow: fedoraplanet
Disallow: Friendica
Disallow: NextCloud
Disallow: Tiny Tiny RSS
Disallow: RegionStuttgartBot
Disallow: Bytespider
Disallow: Datanyze
Disallow: Google-Site-Verification
Disallow: TrendsmapResolver
Disallow: tweetedtimes
Disallow: NTENTbot
Disallow: Gwene
Disallow: SimplePie
Disallow: SearchAtlas
Disallow: Superfeedr
Disallow: feedbot
Disallow: UT-Dorkbot
Disallow: Amazonbot
Disallow: SerendeputyBot
Disallow: Eyeotabot
Disallow: officestorebot
Disallow: Neticle Crawler
Disallow: SurdotlyBot
Disallow: LinkisBot
Disallow: AwarioSmartBot
Disallow: AwarioRssBot
Disallow: RyteBot
Disallow: FreeWebMonitoring SiteChecker
Disallow: AspiegelBot
Disallow: NAVER Blog Rssbot
Disallow: zenback bot
Disallow: SentiBot
Disallow: Domains Project
Disallow: Pandalytics
Disallow: VKRobot
Disallow: bidswitchbot
Disallow: tigerbot
Disallow: NIXStatsbot
Disallow: Atom Feed Robot
Disallow: Curebot
Disallow: PagePeeker
Disallow: Vigil
Disallow: rssbot
Disallow: startmebot
Disallow: JobboerseBot
Disallow: seewithkids
Disallow: NINJA bot
Disallow: Cutbot
Disallow: BublupBot
Disallow: BrandONbot
Disallow: RidderBot
Disallow: YandexMetrika
Disallow: YandexTurbo
Disallow: YandexImageResizer
Disallow: YandexVideoParser
Disallow: Taboolabot
Disallow: Dubbotbot
Disallow: FindITAnswersbot
Disallow: infoobot
Disallow: Refindbot
Disallow: BlogTrafficd.d+ Feed-Fetcher
Disallow: SeobilityBot
Disallow: Cincraw
Disallow: Dragonbot
Disallow: VoluumDSP-content-bot
Disallow: FreshRSS
Disallow: a
Disallow: /
Disallow: /amp
Disallow: myspider
Disallow: spider or similar
Allow: instal deploy development inside path
ENDLESS_UP_AND_DOWN=/
ENDLESS_OUT_AND_IN=/
lookalike
background:opt_out
